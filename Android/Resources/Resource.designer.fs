...
[<assembly: Android.Runtime.ResourceDesignerAttribute("WalkingGame.Droid.Resource", IsApplication=true)>]
do ()
namespace WalkingGame.Droid
    ...
    exception ReturnException3bdc28f23f624c468d757a4b5f778ab4 of obj
    exception ReturnNoneException3bdc28f23f624c468d757a4b5f778ab4
    [<AutoOpen>]
    module FuncConvertFinalOverload3bdc28f23f624c468d757a4b5f778ab4 =
    ...
    and
        ...
        (* partial *)Resource_Style () =
            ...
            static member Theme_Splash = 2130903040
            (* Member of type 'CodeTypeConstructor' is not supported by the CodeDOM provider and was omitted *)
